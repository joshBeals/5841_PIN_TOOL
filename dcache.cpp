...
std::string decimalToMemoryStyleHex(unsigned long long decimalValue) {
    std::stringstream stream;
    stream << "0x" << std::hex << std::uppercase << std::setw(16) << std::setfill('0') << decimalValue;
    return stream.str();
}
/* ===================================================================== */
VOID Fini(int code, VOID * v) {
    ...
    outFile <<
        "#\n"
    "******* TOP 20 INSTRUCTIONS AND ROUTINES **********\n"
    "#\n";

    outFile << std::left << std::setw(6) << "No." << std::left << std::setw(18) << "ADDRESS" << "\t" << "NAME" << std::endl;
    ...
    while (i < 20) {
        ...
        const ADDRINT * a = new ADDRINT(addrS[max_rout]);
        std::string memoryStyleHex = decimalToMemoryStyleHex(* a);
        outFile << std::left << std::setw(6) << i+1  << std::left << std::setw(18) << memoryStyleHex << "\t"  << * s << endl;
        temp_3[max_rout] = 0;
        i++;
    }
    outFile <<
    ...
    outFile << std::left << std::setw(6) << "No." << std::left << std::setw(18) << "ADDRESS" << "\t" << "MISSES" << "\t" << "NAME" << std::endl;
    ...
    while (i < 20) {
        ...
        const ADDRINT * a = new ADDRINT(addr[max_rout]);
        std::string memoryStyleHex = decimalToMemoryStyleHex(* a);
        outFile << std::left << std::setw(6) << i+1  << std::left << std::setw(18) << memoryStyleHex << "\t" << temp_1[max_rout] << "\t" << * s << endl;
   ...
   int j = 0;
    while (j < 20) {
        ...
        const ADDRINT * a = new ADDRINT(addrL[max_rout]);
        std::string memoryStyleHex = decimalToMemoryStyleHex(* a);
        outFile << std::left << std::setw(6) << j+1  << std::left << std::setw(18) << memoryStyleHex << "\t" << temp_2[max_rout] << "\t" << * s << endl;
        temp_2[max_rout] = 0;
        j++;
    }
    outFile <<
